...
from ml.models.xgboost_model import train_xgboost, evaluate_xgboost
...
def run_train_xgboost():
    ...
    print("Training XGBoost on URL features...")
    ...
    with open("ml/saved_models/xgboost.pkl", "wb") as f:
        pickle.dump(model, f)
    with open("ml/saved_models/feature_cols.pkl", "wb") as f:
        pickle.dump(feature_cols, f)

    print("XGBoost saved to ml/saved_models/xgboost.pkl")
